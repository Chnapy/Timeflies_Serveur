...
import MoteurJeu.caracteristique.Caracteristique;
import Combat.entite.NiveauSymbolique;
import MoteurJeu.gameplay.envoutement.Envoutement;
import Combat.sort.SortActif;
import Combat.sort.SortVariable;
import Combat.sort.base.Deplacer;
import Combat.sort.base.Orienter;
import Combat.sort.pileaction.Action;
import Combat.sort.pileaction.PileAction;
